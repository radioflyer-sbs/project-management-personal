    ...
    tasks: [
        ...
        },
        {
            ...
            body: {
                ...
                description: 'string (default "") — Markdown (links, bold, italic, lists, headings)',
                urgency: '"long-term-goal"|"low"|"normal"|"important"|"urgent"|"immediate" (default "normal")',
                isComplete: 'boolean (default false)',
                dueDate: 'ISO 8601 string (optional) — due date/time; drives the card countdown',
        ...
        },
        {
            ...
            body: {
                ...
                description: 'string (optional) — Markdown (links, bold, italic, lists, headings)',
                urgency: '"long-term-goal"|"low"|"normal"|"important"|"urgent"|"immediate" (optional)',
                isComplete: 'boolean (optional)',
                dueDate: 'ISO 8601 string | null (optional) — set or (null) clear the due date',
    ...
    notes: [
        ...
        },
        {
            ...
            body: {
                ...
                ancestorTaskIds: 'string[] (default [])',
                title: 'string (required)',
                details: 'string (optional) — Markdown (links, bold, italic, lists, headings)',
